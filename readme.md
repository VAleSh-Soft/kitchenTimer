# KitchenTimer v 3.4.8

Двухканальный кухонный таймер с часами, построенный на модуле DS3231 и семисегментном индикаторе на драйвере TM1637. Помещается в атмегу 168 (но без загрузчика).
...
1. <a href=#l9>Кнопка Mode</a>
- <a href=#20>Подключение компонентов</a>
...
- <a href=#l9>**Mode**</a> - переключение режима экрана;
